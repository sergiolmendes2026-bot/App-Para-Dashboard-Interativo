...
with filtro_col1:
    periodo = st.selectbox("Período", ["Período a 2026", "Período anterior"], label_visibility="visible")
with filtro_col2:
    produto = st.selectbox("Produto", ["Todos", "Software A", "Software C", "Consultoria"], label_visibility="visible")
with filtro_col3:
    equipe = st.selectbox("Equipe", ["Todas", "Equipe Norte", "Equipe Sul"], label_visibility="visible")
with filtro_col4:
    compra = st.selectbox("Compra", ["Todas", "Econômica", "Premium"], label_visibility="visible")
with filtro_col5:
    consultor = st.selectbox("Consultor", ["Todos", "Alex Silva", "Carlos Souza"], label_visibility="visible")
with filtro_col6:
