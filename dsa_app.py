...
if selected == "Dashboard":
    ...
    # Paleta de cores moderna para o tema escuro
    color_palette = ["#3b82f6", "#8b5cf6", "#ec4899", "#10b981", "#f59e0b"]
    ...
    with g1:
        ...
        if not df_pipeline.empty:
            ...
            st.info("Sem dados para o funil.")
    ...
    with g2:
        ...
        if not df_pipeline.empty:
            ...
            st.info("Sem dados para o gráfico de barras.")
