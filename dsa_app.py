...
if selected == "Dashboard":
    ...
    if not df_leads_filtered.empty:
        ...
        st.dataframe(df_leads_filtered, use_container_width=True, hide_index=True)

# --- PÁGINA: ATIVIDADES (COMPLETA) ---
